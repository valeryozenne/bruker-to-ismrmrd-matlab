...
output_filename = '/home/valery/Reseau/Imagerie/For_Valery/TestRecoKylian/ExVivo/FID/data_69_cut.h5';
...
number_of_lines=number_of_lines/ex.method.PVM_NEchoImages*3; %%modif special


test_data_for_acqp_1=data_for_acqp(:,:,1:ex.method.PVM_NEchoImages:end);
test_data_for_acqp_2=data_for_acqp(:,:,2:ex.method.PVM_NEchoImages:end);
test_data_for_acqp_3=data_for_acqp(:,:,3:ex.method.PVM_NEchoImages:end);
