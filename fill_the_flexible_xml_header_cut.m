function [ header ] = fill_the_flexible_xml_header_cut( ex )
...
header.encoding.encodingLimits.contrast.maximum = 2; %ex.method.PVM_NEchoImages-1;
...
header.sequenceParameters.TE= ex.acqp.ACQ_echo_time(1:3);
