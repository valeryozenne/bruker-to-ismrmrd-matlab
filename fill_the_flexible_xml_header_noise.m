function [ header ] = fill_the_flexible_xml_header_noise( ex )
...
header.measurementInformation.measurementID='1';
header.measurementInformation.patientPosition='HFS';
header.measurementInformation.protocolName='AdjCoilSens';
header.measurementInformation.frameOfReferenceUID='lalala'
% header.measurementInformation.seriesDescription='Tutu';
